...
_reactDomParser2.default.register({ Input: _input2.default, Player: _player2.default });
...
},{"./classes/input":2,"./classes/player":3,"react-dom-parser":5}],2:[function(require,module,exports){
'use strict';
		...
		value: function render() {
			...
			if (this.props.attributes.type == 'radio') {
				...
				return _react2.default.createElement(
					'span',
					null,
					_react2.default.createElement(this.props.tag, _extends({ ref: 'form-element' }, this.props.attributes, { onChange: this.handleChange.bind(this), value: this.state.value, onFocus: this.handleFocus.bind(this), onBlur: this.handleBlur.bind(this), className: this.state.valid ? null : 'error' })),
					(function () {
						if (!self.state.valid) {
							return _react2.default.createElement(
								'span',
...
},{"react":162,"react-dom":6}],6:[function(require,module,exports){
'use strict';
